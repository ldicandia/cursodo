                ...
                <form className="space-y-6">
                    ...
                    <div className="pt-6 border-t flex flex-col gap-4">
                        ...
                        <Link
                            ...
                            className="w-full flex justify-center py-4 px-4 rounded-xl shadow-lg shadow-primary/25 font-bold text-lg text-primary-foreground bg-primary hover:bg-primary/90 hover:scale-[1.02] active:scale-95 transition-all"
                        >
                            Pay ${499} & Enroll
                        </Link>

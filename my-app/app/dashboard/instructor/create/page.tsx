        ...
        <div className="container mx-auto px-4 py-8 max-w-3xl">
            ...
            <div className="bg-card border rounded-3xl p-6 sm:p-10 shadow-sm">
                <div className="mb-8 border-b pb-6">
                    <h1 className="text-3xl font-bold text-foreground">Publish a New Course</h1>
                    <p className="text-muted-foreground mt-2">Fill out the details below to create and publish your course to students.</p>
                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g. Advanced Digital Implantology"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Describe the topics covered, learning outcomes, etc."
                            />
                        </div>
                    </div>
